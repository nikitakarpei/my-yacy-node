...
This is the smallest deployment: a peer with no crawler and no search UI. It contributes
storage and search capacity to the YaCy network and nothing else.
