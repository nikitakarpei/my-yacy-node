...
func scanLinkTree(root *html.Node) linkTreeScan {
	var scan linkTreeScan
...
func (scan *linkTreeScan) inspect(node *html.Node) {
...
func (scan *linkTreeScan) readMetaRobots(node *html.Node) {
