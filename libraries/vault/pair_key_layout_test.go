...
func TestPairKeyRoundTripsBothPositions(t *testing.T) {
	layout := vault.PairKey(vault.TextKeyPart, vault.TextKeyPartDescending)
...
func TestPairKeyRangesOfTheFirstPositionSplitAtThatFirst(t *testing.T) {
	layout := vault.PairKey(vault.TextKeyPart, vault.TextKeyPart)
	firsts := orderedTexts()
...
func TestPairKeysSortByFirstThenSecond(t *testing.T) {
	layout := vault.PairKey(vault.TextKeyPart, vault.IntegerKeyPart)
...
func TestPairKeyPartsRejectsAKeyOfAnotherLayout(t *testing.T) {
	layout := vault.PairKey(vault.TextKeyPart, vault.TextKeyPart)
