# 3.1. Use Elasticsearch instead of Manticore

> "Can I keep my local search index in Elasticsearch?"

Chapter 3 stores crawled text in Manticore. This chapter stores the text in
Elasticsearch instead. Use it when you already operate Elasticsearch or need
its tools.
