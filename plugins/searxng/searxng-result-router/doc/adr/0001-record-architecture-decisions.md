...
The plugin introduces a third-party runtime dependency (SearXNG's plugin API) and structural
choices of its own. We want a durable, reviewable record of why each was made.
