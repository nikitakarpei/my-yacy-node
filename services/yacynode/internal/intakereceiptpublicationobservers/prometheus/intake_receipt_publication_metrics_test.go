...
import (
	...
	intakereceiptpublicationmetrics "github.com/nikitakarpei/yacy-rwi-node/yacynode/internal/intakereceiptpublicationobservers/prometheus"
)
...
func TestIntakeReceiptPublicationMetricsCountsEveryOutcome(t *testing.T) {
	...
	for _, want := range []string{
		`yacynode_intake_receipt_publications_total{outcome="sent"} 1`,
		`yacynode_intake_receipt_publications_total{outcome="encoding_failed"} 1`,
		`yacynode_intake_receipt_publications_total{outcome="publishing_failed"} 1`,
		`yacynode_intake_receipt_publications_total{outcome="confirmation_failed"} 1`,
	} {
