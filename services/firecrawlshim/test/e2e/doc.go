...
// corpusmarkdown, and firecrawlshim on a hermetic Docker network, then calls the
// firecrawlshim HTTP /v1/scrape endpoint from the host. The scrape orders a crawl,
// waits for corpusmarkdown to hold the markdown, and returns it in the Firecrawl
