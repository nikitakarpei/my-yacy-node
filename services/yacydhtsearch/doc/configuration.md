...
| `YACYDHTSEARCH_REPLICAS_COVERING_A_PARTITION` | `1` | Replicas that must list, count or match documents of one word partition before the search stops asking its other replicas. A value above the redundancy stops the service from starting. |
