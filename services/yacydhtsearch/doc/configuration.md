...
| `YACYDHTSEARCH_PEER_RETRIAL_INTERVAL` | `24h` | Time after which a judged peer is asked again. With `YACYDHTSEARCH_NATS_URL` set, the judgements are shared by all instances and kept over a restart. |
