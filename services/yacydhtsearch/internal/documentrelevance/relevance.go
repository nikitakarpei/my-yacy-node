...
// it holds. A query word nobody counted for a document scores as a word a node
// counted no hit of. A length or a link density nobody counted scores as the
// average of the documents a node counted.
