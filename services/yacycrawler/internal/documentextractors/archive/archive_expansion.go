...
func (a ArchiveExpansion) expandZip(
	...
	var members []contentextraction.ArchiveMember
	...
	for _, file := range reader.File {
		...
		if len(members) > a.maxMembers {
			return nil, contentextraction.ErrContainerOverflow
		}
	}
	return members, nil
}
...
func (a ArchiveExpansion) expandGzip(
	...
	return []contentextraction.ArchiveMember{member}, nil
}
...
func (a ArchiveExpansion) member(
	...
	content []byte,
	claimed map[string]struct{},
) (contentextraction.ArchiveMember, bool) {
	...
	if err != nil {
		...
		return contentextraction.ArchiveMember{}, false
	}
	...
	return contentextraction.ArchiveMember{
		URL:         memberURL,
