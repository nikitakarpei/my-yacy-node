...
func (a *Absorption) publish(ctx context.Context, page CrawledPage) error {
	...
	if published == 0 {
		...
		a.observer.PageDisposed(DisposalUnrepresentable)
	}
	return nil
}
...
func (a *Absorption) deriveContents(
	page CrawledPage,
) (map[contentformatgraph.Format][]byte, error) {
