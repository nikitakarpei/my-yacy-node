...
type TimedPageFetcher struct {
	inner    pagefetch.Fetcher
	clock    Clock
	observer PageFetchObserver
}

func NewTimedPageFetcher(
	inner pagefetch.Fetcher,
	clock Clock,
	observer PageFetchObserver,
) *TimedPageFetcher {
	return &TimedPageFetcher{inner: inner, clock: clock, observer: observer}
}

func (f *TimedPageFetcher) Fetch(
	ctx context.Context,
	pageURL canonicalurl.CanonicalURL,
	knownVersion pagefetch.PageVersion,
) pagefetch.FetchOutcome {
...
func (f *TimedPageFetcher) observeUnfinishedFetch(
	ctx context.Context,
	pageURL canonicalurl.CanonicalURL,
...
func (f *TimedPageFetcher) observeFetchOutcome(
	ctx context.Context,
	pageURL canonicalurl.CanonicalURL,
	fetchDuration time.Duration,
