...
func orderDelivery(seeds []string) ordersettlement.DeliveredOrder {
	return ordersettlement.DeliveredOrder{
...
func TestTraverseBudgetTruncates(t *testing.T) {
	...
	if observer.budget != 1 || observer.disposed[ordertraversal.DisposalBudgetTruncated] == 0 {
...
func TestTraverseDefersThenGivesUp(t *testing.T) {
	...
	if observer.refusals[ordertraversal.RefusalDefer] == 0 {
