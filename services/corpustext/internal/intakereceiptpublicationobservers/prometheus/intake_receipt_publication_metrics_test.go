...
import (
	...
	intakereceiptpublicationmetrics "github.com/nikitakarpei/yacy-rwi-node/corpustext/internal/intakereceiptpublicationobservers/prometheus"
)
...
func TestIntakeReceiptPublicationMetricsCountsEveryOutcome(t *testing.T) {
	...
	for _, want := range []string{
		`corpustext_intake_receipt_publications_total{outcome="sent"} 1`,
		`corpustext_intake_receipt_publications_total{outcome="encoding_failed"} 1`,
		`corpustext_intake_receipt_publications_total{outcome="publishing_failed"} 1`,
		`corpustext_intake_receipt_publications_total{outcome="confirmation_failed"} 1`,
	} {
