...
func (m *IntakeProgressMetrics) NoReadableTextDerived(
	_ context.Context,
	_ canonicalurl.CanonicalURL,
) {
...
func (m *IntakeProgressMetrics) IndexObserved(_ context.Context, elapsed time.Duration) {
	m.indexDurationSecs.Observe(elapsed.Seconds())
}

func (m *IntakeProgressMetrics) IndexFailed(
	_ context.Context,
	_ canonicalurl.CanonicalURL,
	_ error,
) {
