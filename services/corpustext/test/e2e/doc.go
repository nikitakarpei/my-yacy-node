...
// yacynode, yacycrawler, and corpustext on a hermetic Docker network, then drives
// the crawler over NATS from the host and polls Elasticsearch's own search API for
// the indexed page.
//
