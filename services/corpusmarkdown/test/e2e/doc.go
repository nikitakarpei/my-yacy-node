...
// and corpusmarkdown on a hermetic Docker network, then drives the crawler over
// NATS from the host and reads the stored markdown back from the JetStream
// Object Store by its URL-addressed name.
//
