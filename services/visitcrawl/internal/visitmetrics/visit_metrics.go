// Package visitmetrics records the visit intake service's operational
// metrics into a Prometheus registry supplied by its caller.
...
func New(registry prometheus.Registerer) *VisitMetrics {
