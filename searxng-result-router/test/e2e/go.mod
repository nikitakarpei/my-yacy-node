module github.com/nikitakarpei/yacy-rwi-node/searxng-result-router/test/e2e
...
replace (
	...
	github.com/nikitakarpei/yacy-rwi-node/yacycrawlcontract => ../../../yacycrawlcontract
	github.com/nikitakarpei/yacy-rwi-node/yacymodel => ../../../yacymodel
)
